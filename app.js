...
const products = [
  new Product(1, "Mjölk 1L", 15, "mejeri", "Färsk svensk mjölk.", "assets/mjölk3.webp"),
  new Product(2, "Smör", 55, "mejeri", "Normalsaltat smör.", "assets/smör.jpg"),
  new Product(3, "Oxfilé", 299, "kott", "Mör oxfilé.", "assets/oxfile.webp"),
  new Product(4, "Kycklingfilé", 120, "kott", "Fryst kyckling.", "assets/kycklingfile.jpg"),
  new Product(5, "Bananer", 25, "frukt", "Ekologiska bananer.", "assets/bananer.jpg"),
  new Product(6, "Äpplen", 29, "frukt", "Svenska äpplen.", "assets/äpple.jpg"),
  new Product(7, "Avocado", 15, "gront", "Mogen avocado.", "assets/avocado.jpg"),
  new Product(8, "Gurka", 12, "gront", "Svensk gurka.", "assets/gurka2.jpg"),
];
